...
from qec.analysis.finite_state_controller import run_finite_state_controller
...
def test_intervention_loop_case(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert out["control_loop_class"] == "intervention_loop"
...
def test_short_chain_edge_case(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert out["control_loop_class"] == "stable_loop"
